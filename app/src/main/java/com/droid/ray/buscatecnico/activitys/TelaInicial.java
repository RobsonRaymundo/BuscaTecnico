    ...
    private void updateUI(int uiState, FirebaseUser user, PhoneAuthCredential cred) {
        switch (uiState) {
            case STATE_INITIALIZED:
                ...
                enableViews(btnConfirmar, edtTelefone);
            ...
            case STATE_CODE_SENT:
                ...
                disableViews(btnConfirmar);
                txtMensagem.setText("Codigo enviado");
                break;
            case STATE_VERIFY_FAILED:
                // Verification has failed, show all options
                enableViews(btnConfirmar, btnEnviar, edtTelefone,
                        edtSms);
                txtMensagem.setText("Codigo falhou");
                break;
            case STATE_VERIFY_SUCCESS:
                // Verification has succeeded, proceed to firebase sign in
                disableViews(btnConfirmar, btnEnviar, edtTelefone,
                        edtSms);
                txtMensagem.setText("Codigo bem sucedido");
            ...
            case STATE_SIGNIN_FAILED:
                ...
                txtMensagem.setText("Falha ao logar");
                break;
